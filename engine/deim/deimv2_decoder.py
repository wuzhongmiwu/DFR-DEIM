...
from .utils import get_activation, inverse_sigmoid, bias_init_with_prob   
...
@register()  
class DEIMV2Transformer(nn.Module):
    ...
    def __init__(self,
        ...
        logger.info(f"     --- Use Share Bbox Head@{share_bbox_head} ---")     
        logger.info(f"     --- Use Share Score Head@{share_score_head} ---")
