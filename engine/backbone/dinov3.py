...
# 通过网盘分享的文件：dinov3_pretrained   
# 链接: https://pan.baidu.com/s/1fUYQXe-8HS0uD_PWs3JrSA?pwd=zbhh 提取码: zbhh 
...
class ConvNeXt(nn.Module):   
    ...
    def forward_features(self, x, masks = None) -> List[Dict[str, Tensor]]:
    ...
    def _freeze_parameters(self):
        ...
        logger.info(f"freeze_parameters success.")
...
class ConvNeXt_Tiny(ConvNeXt):
    def __init__(self, **kwargs):     
        kwargs.setdefault("depths", convnext_sizes["tiny"]["depths"])     
        kwargs.setdefault("dims", convnext_sizes["tiny"]["dims"])
...
class ConvNeXt_Small(ConvNeXt):     
    def __init__(self, **kwargs):
        kwargs.setdefault("depths", convnext_sizes["small"]["depths"])  
        kwargs.setdefault("dims", convnext_sizes["small"]["dims"])    
        super().__init__(**kwargs)   
...
class ConvNeXt_Base(ConvNeXt):     
    def __init__(self, **kwargs):
        kwargs.setdefault("depths", convnext_sizes["base"]["depths"]) 
        kwargs.setdefault("dims", convnext_sizes["base"]["dims"])     
        super().__init__(**kwargs)  
...
class ConvNeXt_Large(ConvNeXt):  
    def __init__(self, **kwargs):   
        kwargs.setdefault("depths", convnext_sizes["large"]["depths"])
        kwargs.setdefault("dims", convnext_sizes["large"]["dims"])     
        super().__init__(**kwargs)
