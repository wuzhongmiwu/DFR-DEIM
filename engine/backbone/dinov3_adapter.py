    ...
    def __init__(  
        ...
        if 'dinov3' in name:
            ...
            if weights_path is not None:   
                logger.info(f'Loading ckpt from {weights_path}...')
        ...
        if use_sta:  
            logger.info(f"Using Lite Spatial Prior Module with inplanes={conv_inplane}")
